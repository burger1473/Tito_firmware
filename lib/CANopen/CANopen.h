...
/*=====================[ Inclusiones ]============================*/
  ...
  #include "../mcan_fd_interrupt/mcan_fd_interrupt.h"
...
/*=====================[Definiciones]================================*/
  ...
  #define CAN_send_timeout        3                          //Tiempo de espera en ms para verificar el envio correcto de mensaje por can
  #define CANopen_RSDO_timeout    2  
  #define CANopen_SDO_mode_client 0
  #define CANopen_SDO_mode_server 1
  #define CANopen_SDO_timeout     30                          //Tiempo de espera en ms para recibir respuesta de servidor
